...
| <a name="input_function_app_ip_addresses_list"></a> [function\_app\_ip\_addresses\_list](#input\_function\_app\_ip\_addresses\_list) | Map of function app ip addresses as list | `map(list(string))` | n/a | yes |
